...
bool MySqlObject::GetUserToken (std::string nickname, std::string & token)
{
	std::string strQuery = "SELECT auth_token FROM userinfo WHERE user_name = \""+ nickname +"\"";
...
bool MySqlObject::ChangeUserNickname (std::string preNickname, std::string postNikcname)
{
	std::string strQuery = 
...
bool MySqlObject::CreateUser (std::string& nickname, std::string& token)
{
	std::string strQuery =
